...
QT_MOC_LITERAL(1, 8, 20), // "getDataFinisedSignal"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 22), // "getDataSuccessedSignal"
QT_MOC_LITERAL(4, 53, 19), // "getDataFailedSignal"
QT_MOC_LITERAL(5, 73, 13), // "replyFinished"
QT_MOC_LITERAL(6, 87, 14), // "QNetworkReply*"
QT_MOC_LITERAL(7, 102, 5) // "reply"

    },
    "Weather\0getDataFinisedSignal\0\0"
    "getDataSuccessedSignal\0getDataFailedSignal\0"
...
void Weather::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getDataFinisedSignal(); break;
        case 1: _t->getDataSuccessedSignal(); break;
        case 2: _t->getDataFailedSignal(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Weather::getDataFinisedSignal)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Weather::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Weather::getDataSuccessedSignal)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Weather::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Weather::getDataFailedSignal)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Weather::getDataFinisedSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Weather::getDataSuccessedSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Weather::getDataFailedSignal()
{
